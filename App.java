...
//=======================================================================================
//=======================================================================================
        StringContactFormatterFactory factory = new StringContactFormatterFactory(18,20);
        Iterable<ContactFormatter> decoracor = new ContactFormatterIterableDecorator(contactBook.read(),factory);
